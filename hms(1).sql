...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2015 at 09:34 AM
...
CREATE TABLE IF NOT EXISTS `cross_refer` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_authoriztion` (
  `username` varchar(12) NOT NULL,
...
('superadmin', 'fcea920f7412b5da7be0cf42b8c93759', 'Admin', 'Out', '2015-07-16 11:18:46'),
('superdoctor', '25d55ad283aa400af464c76d713c07ad', 'Doctor', 'Out', '2015-07-16 11:30:09'),
('superpharm', '25d55ad283aa400af464c76d713c07ad', 'Pharmacy', 'Out', '2015-07-16 11:28:05'),
('superreg', '25d55ad283aa400af464c76d713c07ad', 'Registration', 'Out', '2015-07-16 11:30:44');
...
ALTER TABLE `prescribed_medicine`
  ADD PRIMARY KEY (`id`), ADD KEY `medicine_data` (`medicine_data`);

--
-- Indexes for table `prescription`
--
ALTER TABLE `prescription`
  ADD PRIMARY KEY (`medicine_data`), ADD UNIQUE KEY `registration` (`registration`);
